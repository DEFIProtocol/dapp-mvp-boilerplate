...
## Remaining Non-Contract Follow-Ups

- Finalize backend/keeper operations spec for options expiry and settlement jobs.
- Define stale-oracle operational policy during settlement windows (ops runbook level).
