  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <div>
          <h1 className={styles.title}>🔑 My API Keys</h1>
            ...
            {myKeys.map((key) => (
              <div key={key.id} className={styles.keyCard}>
                <div className={styles.keyHeader}>
                  <div>
                    <h3 className={styles.keyName}>{key.owner_name || "Unnamed Project"}</h3>
                ...
                <div className={styles.keyActions}>
                  ...
                  <button className={styles.secondaryButton}>View Usage</button>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Available Tiers */}
      <div className={styles.section}>
        <h2 className={styles.sectionTitle}>Available Tiers</h2>
      ...
      {showRequestModal && (
        <div className={styles.modal} onClick={() => setShowRequestModal(false)}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            <h2 className={styles.modalTitle}>Request API Key</h2>
