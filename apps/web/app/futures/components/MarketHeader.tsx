      ...
      <div className={styles.headerContent}>
        ...
        <div className={styles.headerActions}>
          <button
            ...
            title={watchlisted ? 'Remove from Futures Watchlist' : 'Add to Futures Watchlist'}
            aria-label={watchlisted ? 'Remove from Futures Watchlist' : 'Add to Futures Watchlist'}
          >
            <span className={styles.watchGlyph} aria-hidden="true">{watchlisted ? '★' : '☆'}</span>
          </button>
        </div>
      </div>
    </div>
